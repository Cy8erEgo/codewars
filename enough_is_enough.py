...
def delete_nth_2(order, max_e):
    ...
    for i in order:
        if new_order.count(i) < max_e: new_order.append(i)
...
assert delete_nth_2([23, 23, 18, 46, 30, 46, 19, 18, 46, 18, 46, 19, 23, 18, 23, 19, 18, 23, 23, 23, 19, 30, 18, 23, 30], 1) == [23, 18, 46, 30, 19]
